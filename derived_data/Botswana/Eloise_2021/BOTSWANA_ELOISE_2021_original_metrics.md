...
|---|---|---|---|
| 219,464.9 | 578,069.8 | 0.380 | 2.6 |

Only 38% of Botswana lies inside the 200 km storm footprint; a national mean would dilute the signal ~3x (DF).

## Eq 6 — % change vs baseline (naive vs corrected)
Naive uses the depressed *observed* baseline; corrected anchors to the climatological baseline level (0.197) on de-meaned anomalies.
...
## Eq 8 — SIF-GPP agreement
- Not computable: too few paired 8-day composites with valid SIF (monsoon blackout).

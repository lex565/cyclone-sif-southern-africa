# Cyclone Guambe (Feb 2021) — original manuscript metrics (Section 3)
...
|---|---|---|---|
| 178,886.4 | 770,805.5 | 0.232 | 4.3 |

Only 23% of Mozambique lies inside the 200 km storm footprint; a national mean would dilute the signal ~4x (DF).

## Eq 6 — % change vs baseline (naive vs corrected)
Naive uses the depressed *observed* baseline; corrected anchors to the climatological baseline level (0.425) on de-meaned anomalies.

...
|---|---|---|---|
| 183,066.4 | 770,805.3 | 0.237 | 4.2 |

Only 24% of Mozambique lies inside the 200 km storm footprint; a national mean would dilute the signal ~4x (DF).

## Eq 6 — % change vs baseline (naive vs corrected)
Naive uses the depressed *observed* baseline; corrected anchors to the climatological baseline level (0.479) on de-meaned anomalies.

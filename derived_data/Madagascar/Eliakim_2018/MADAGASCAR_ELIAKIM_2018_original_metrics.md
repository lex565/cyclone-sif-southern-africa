# Cyclone Eliakim (Mar 2018) — original manuscript metrics (Section 3)
...
|---|---|---|---|
| 161,743.3 | 590,084.8 | 0.274 | 3.6 |

Only 27% of Madagascar lies inside the 200 km storm footprint; a national mean would dilute the signal ~4x (DF).

## Eq 6 — % change vs baseline (naive vs corrected)
Naive uses the depressed *observed* baseline; corrected anchors to the climatological baseline level (0.516) on de-meaned anomalies.
...
| late_recovery | +45..+60 | 7122 | NA | NA | 0.947 |

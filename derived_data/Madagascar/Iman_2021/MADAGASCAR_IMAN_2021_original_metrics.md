# Cyclone Iman (Mar 2021) — original manuscript metrics (Section 3)
...
Naive uses the depressed *observed* baseline; corrected anchors to the climatological baseline level (0.421) on de-meaned anomalies.
...
| late_recovery | +45..+60 | 4716 | NA | NA | 1.007 |

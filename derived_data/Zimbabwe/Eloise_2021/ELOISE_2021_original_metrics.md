...
|---|---|---|---|
| 79,154.4 | 390,647.3 | 0.203 | 4.9 |

Only 20% of Zimbabwe lies inside the 200 km storm footprint; a national mean would dilute the signal ~5x (DF).

## Eq 6 — % change vs baseline (naive vs corrected)
Naive uses the depressed *observed* baseline; corrected anchors to the climatological baseline level (0.272) on de-meaned anomalies.
